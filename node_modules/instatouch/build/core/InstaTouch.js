...
class InstaTouch {
    constructor({ url, download = false, filepath = '', filename = '', filetype, input, count, proxy, session, mediaType = 'all', scrapeType, asyncDownload, userAgent, progress = false, store_history = false, timeout, cli, endCursor, bulk = false, historyPath, zip = false, headers = {}, }) {
        this.zip = zip;
        this.url = url;
    ...
    async startScraper() {
        ...
        return Object.assign(Object.assign(Object.assign(Object.assign({ count: this.itemCount, has_more: this.hasNextPage, end_cursor: this.endCursor, collector: this.collector }, (this.filetype === 'all' ? { json, csv } : {})), (this.filetype === 'json' ? { json } : {})), (this.filetype === 'csv' ? { csv } : {})), { auth_error: this.auth_error });
    }
    get fileDestination() {
        if (this.fileName) {
